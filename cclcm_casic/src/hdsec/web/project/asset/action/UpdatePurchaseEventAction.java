...
class UpdatePurchaseEventAction extends AssetBaseAction {
	...
	private final String jobType = JobTypeEnum.PURCHASE.getJobTypeCode();
	...
	public void setEvent(PurchaseEvent event) {
		this.event = event;
	}
	...
	public String executeFunction() throws Exception {
		if (StringUtils.hasLength(update)) {
			...
			PurchaseEvent even = new PurchaseEvent(user_iidd, dept_id,
					...
					property_kind);
			assetService.delPurchaseEventByEnterCode(event_code, "del");
			assetService.addPurchaseEvent(even);
			insertCommonLog("修改资产采购申请作业[" + event_code + "]");
