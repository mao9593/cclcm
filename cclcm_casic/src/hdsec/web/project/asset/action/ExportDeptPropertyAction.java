 ...
 * 
 */
public class ExportDeptPropertyAction extends PropertyExportAction {
	...
	private final String filename = "部门资产台账记录-" + ".xls";
	private final String sheetName = "部门资产台账记录";
	...
	public String executeFunction() throws Exception {
		...
		map.put("duty_dept_id", getSecUserFromSession().getDept_id());
