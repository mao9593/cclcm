 ...
 * 
 */
public class IntegrationIndexAction extends ActionSupport {
	 ...
	 * 如果session中存在用户，并且与当前用户相同，则不做处理，否则把session中的用户信息更新为当前用户
	 * @param user_iidd
	 * @throws Exception
	 */
	...
	public String execute() {
		...
		userService.updateViewStatus(user_iidd,url);
		return SUCCESS;
	}
