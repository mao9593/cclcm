...
public enum EntityStateEnum {
	STATE0(0, "留用", true), STATE5(5, "流转中", false), STATE6(6, "借阅中", false), STATE8(8, "申请外发", true), STATE9(9, "申请归档",
			true), STATE7(7, "申请销毁", true), STATE10(10, "待交接", false), STATE1(1, "已回收", true), STATE2(2, "已外发", true), STATE3(
			3, "已归档", false), STATE4(4, "已销毁", false), STATE11(11, "送销", true), STATE12(12, "归属转换中", true), STATE13(13,
			"密级变更中", true);
	private Integer key;
	private String name = "";
