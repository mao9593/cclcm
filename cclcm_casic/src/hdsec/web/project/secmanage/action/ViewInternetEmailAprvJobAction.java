 ...
 * @author guojiao
 */
public class ViewInternetEmailAprvJobAction extends SecManageBaseAction {
	...
	public String executeFunction() throws Exception {
		...
		tempList = basicService.getApprovedJobByUserId(getCurUser().getUser_iidd(), JobTypeEnum.INTER_EMAIL, user_name,
				seclv_code);
