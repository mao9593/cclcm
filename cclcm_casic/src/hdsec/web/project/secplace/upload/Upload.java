package hdsec.web.project.secplace.upload;
...
public class Upload extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// String seclv_code = request.getParameter("seclv_code");
		...
		try {
			...
			if (path.canWrite()) {
				...
				// urlBuffer.append("/" + curUser.getUser_iidd()).append("/" + fileName );
				...
				logger.error("指定的上传文件临时存放路径[" + tempPath + "]没有可写权限，请设置该路径权限");
			}
		} catch (Exception e) {
