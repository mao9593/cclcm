 ...
 */
public class ViewSecplaceAprvJobAction extends SecplaceBaseAction {
	...
	public String executeFunction() throws Exception {
		...
		tempList = basicService.getApprovedJobByUserId(getCurUser().getUser_iidd(), JobTypeEnum.EVENT_SECPLACE,
