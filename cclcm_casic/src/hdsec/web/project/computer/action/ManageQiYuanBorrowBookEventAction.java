 ...
 * @author guojiao
 */
public class ManageQiYuanBorrowBookEventAction extends ComputerBaseAction {
	...
	public String executeFunction() throws Exception {
		...
		basicService.setClientMsgRead(getCurUser().getUser_iidd(), "QIYUAN_BORROW_BOOK", 2);
		basicService.setClientMsgRead(getCurUser().getUser_iidd(), "QIYUAN_BORROW_BOOK", 3);
