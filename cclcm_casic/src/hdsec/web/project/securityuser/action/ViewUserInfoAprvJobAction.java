 ...
 * @author guojiao
 */
public class ViewUserInfoAprvJobAction extends SecurityUserBaseAction {
	...
	public String executeFunction() throws Exception {
		...
		tempList = basicService.getApprovedJobByUserId(getCurUser().getUser_iidd(), JobTypeEnum.USER_INFO, user_name,
				seclv_code);
