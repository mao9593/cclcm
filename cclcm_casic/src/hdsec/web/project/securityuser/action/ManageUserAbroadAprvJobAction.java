 ...
 * @author gj
 */
public class ManageUserAbroadAprvJobAction extends SecurityUserBaseAction {
	...
	public String executeFunction() throws Exception {
		...
		candidateList = basicService.getCandidateListByUserId(getCurUser().getUser_iidd(), JobTypeEnum.SECUSER_ABROAD);
