 ...
 * @author gj
 */
public class ManageUserAbroadListAction extends SecurityUserBaseAction {
	...
	private JobTypeEnum jobType = JobTypeEnum.SECUSER_ABROAD;
	...
	public String getActionContext() {
		return "/securityuser/manageuserabroadlist.action";
	}
	...
	public String executeFunction() throws Exception {
		...
		eventList = securityUserService.getUAbroadEventList(map);
