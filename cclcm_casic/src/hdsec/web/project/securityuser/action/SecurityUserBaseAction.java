...
public abstract class SecurityUserBaseAction extends BaseAction {
	...
	// 个人头像
	public String getHeadShot(String userid) {
		String tempPath = "";
		String headpath = "";
		try {
			tempPath = BMPropertyUtil.getSecManageStrorePath() + "/" + "headshot" + "/" + userid;
		} catch (Exception e1) {
			e1.printStackTrace();
		}
