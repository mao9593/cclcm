 ...
 * 
 */
public class ViewOperLogCommonAction extends LogBaseAction {
	...
	public List<CommonOperLog> getLogList() {
		return logList;
	}
	...
	public String executeFunction() throws Exception {
		...
		totalSize = logService.getCommonOperLogSize(map);
		logList = logService.getCommonOperLog(map, rbs);
		return SUCCESS;
	}
}
