 ...
 * 
 */
public class ExportOperlogAdminAction extends LogExportXlsAction {
	private static final long serialVersionUID = 1L;
	private List<AdminOperLog> logList = null;
	private String user_name = "";
	private String dept_name = "";
	private String result = "";
	private Date startTime = null;
	private Date endTime = null;
	private String filename = "管理员操作日志-" + sdf1.format(new Date()) + ".xls";
	private String sheetName = "管理员操作日志";
	...
	public String executeFunction() throws Exception {
		...
		while (prestart || (logList != null && logList.size() == SHEET_ROW_NUM)) {
			beginIndex = sheetNum * SHEET_ROW_NUM;
			logList = logService.getAdminOperLog(map, new RowBounds(beginIndex, SHEET_ROW_NUM));
	...
	private void insertRow(HSSFRow row, AdminOperLog log) {
		int index = 0;
