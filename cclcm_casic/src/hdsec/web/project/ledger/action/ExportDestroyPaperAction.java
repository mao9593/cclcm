 ...
 * 
 */
public class ExportDestroyPaperAction extends AutoCommonExportAction {
	...
	private final String filename = "已销毁文件台账记录-" + sdf1.format(new Date()) + ".xls";
	private final String sheetName = "已销毁文件台账记录";
	private String cols= "";
	...
	public String executeFunction() throws Exception {
		cols=basicService.getSysConfigItemValue("exportdestroypaper").getItem_value();
