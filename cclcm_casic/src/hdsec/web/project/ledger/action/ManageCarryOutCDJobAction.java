 ...
 * @author fyp
 */
public class ManageCarryOutCDJobAction extends LedgerBaseAction {
	...
	private JobTypeEnum jobType = JobTypeEnum.CARRYOUT_CD;
	...
	public String getJobType_code() {
		return JobTypeEnum.CARRYOUT_CD.getJobTypeCode();
	}
	...
	public String executeFunction() throws Exception {
		...
		map.put("jobType_code", JobTypeEnum.CARRYOUT_CD);
		...
		basicService.setClientMsgRead(getCurUser().getUser_iidd(), "CARRYOUT_CD", 2);
		basicService.setClientMsgRead(getCurUser().getUser_iidd(), "CARRYOUT_CD", 3);
		return SUCCESS;
	}
}
