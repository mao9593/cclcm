 ...
 * 
 */
public class FilePaperApplyAction extends LedgerBaseAction {
	...
	public String executeFunction() throws Exception {
		...
		totalSize = ledgerService.getFilePaperSize(map);
		beginIndex = page * pageSize;
		RowBounds rbs = new RowBounds(beginIndex, pageSize);
		paperLedgerList = ledgerService.getFilePaperList(map, rbs);
		basicService.setClientMsgRead(getCurUser().getUser_iidd(), "FILE_PAPER", 2);
		basicService.setClientMsgRead(getCurUser().getUser_iidd(), "FILE_PAPER", 3);
		return SUCCESS;
	}
