 ...
 * 
 */
public class ManageCarryOutConfirmPaperEventListAction extends LedgerBaseAction {
	...
	public String executeFunction() throws Exception {
		...
		map.put("jobType_code", JobTypeEnum.CARRYOUT_PAPER.getJobTypeCode());

		map.put("job_status", "true");
		map.put("startTime", startTime);
		map.put("endTime", endTime);
		map.put("carryoutStatus", 0);
