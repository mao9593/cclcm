...
public class ViewSelfPaperRecycleLedgerAction extends LedgerBaseAction {
	...
	public String getSeclv_codes() {
		return seclv_codes;
	}

	public void setSeclv_codes(String seclv_codes) {
		this.seclv_codes = seclv_codes;
	}
	...
	public String executeFunction() throws Exception {
		...
		totalSize = ledgerService.getAllPaperRecycleLedgerSize(map);
		List<EntityPaper> listPaperLedger = ledgerService.getAllPaperRecycleLedgerList(map, rbs);
		...
		basicService.setClientMsgRead(getCurUser().getUser_iidd(), "DESTROY_PAPER", 2);
		return SUCCESS;
	}
