 ...
 * 
 */
public class ManageFilePaperEventAction extends LedgerBaseAction {
	...
	public String executeFunction() throws Exception {
		...
		basicService.setClientMsgRead(getCurUser().getUser_iidd(), "FILE_DESTROY", 2);
		basicService.setClientMsgRead(getCurUser().getUser_iidd(), "FILE_DESTROY", 3);
		return SUCCESS;
	}
}
