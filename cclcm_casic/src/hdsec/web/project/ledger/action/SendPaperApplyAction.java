 ...
 * 
 */
public class SendPaperApplyAction extends LedgerBaseAction {
	...
	public List<EntityStateEnum> getStateList() {
		...
		list.add(EntityStateEnum.STATE8);
		list.add(EntityStateEnum.STATE16);
		list.add(EntityStateEnum.STATE2);
		return list;
	}
	...
	public String executeFunction() throws Exception {
		...
		totalSize = ledgerService.getAllSendPaperSize(map);
		beginIndex = page * pageSize;
		RowBounds rbs = new RowBounds(beginIndex, pageSize);
		paperLedgerList = ledgerService.getSendPaperList(map, rbs);
		basicService.setClientMsgRead(getCurUser().getUser_iidd(), "SEND_PAPER", 2);
		basicService.setClientMsgRead(getCurUser().getUser_iidd(), "SEND_PAPER", 3);
		return SUCCESS;
	}
