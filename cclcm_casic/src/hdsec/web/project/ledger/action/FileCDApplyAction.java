 ...
 * 
 */
public class FileCDApplyAction extends LedgerBaseAction {
	...
	public String executeFunction() throws Exception {
		...
		totalSize = ledgerService.getFileCDSize(map);
		beginIndex = page * pageSize;
		RowBounds rbs = new RowBounds(beginIndex, pageSize);
		cdLedgerList = ledgerService.getFileCDList(map, rbs);
		basicService.setClientMsgRead(getCurUser().getUser_iidd(), "FILE_CD", 2);
		basicService.setClientMsgRead(getCurUser().getUser_iidd(), "FILE_CD", 3);
		return SUCCESS;
	}
