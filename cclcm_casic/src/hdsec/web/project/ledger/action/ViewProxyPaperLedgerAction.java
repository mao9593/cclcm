 ...
 * 
 */
public class ViewProxyPaperLedgerAction extends LedgerBaseAction {
	...
	public String executeFunction() throws Exception {
		...
		totalSize = ledgerService.getProxyPaperLedgerSize(map);
		List<EntityPaper> listPaperLedger = ledgerService.getProxyPaperLedgerList(map, rbs);
