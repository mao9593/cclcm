 ...
 * 
 */
public class DelayPaperApplyAction extends LedgerBaseAction {
	...
	public String executeFunction() throws Exception {
		...
		totalSize = ledgerService.getDelayPaperSize(map);
		beginIndex = page * pageSize;
		RowBounds rbs = new RowBounds(beginIndex, pageSize);
		paperLedgerList = ledgerService.getDelayPaperList(map, rbs);
		basicService.setClientMsgRead(getCurUser().getUser_iidd(), "DELAY_PAPER", 2);
		basicService.setClientMsgRead(getCurUser().getUser_iidd(), "DELAY_PAPER", 3);
		return SUCCESS;
	}
