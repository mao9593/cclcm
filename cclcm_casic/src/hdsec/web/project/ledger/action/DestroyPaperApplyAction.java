 ...
 * 
 */
public class DestroyPaperApplyAction extends LedgerBaseAction {
	...
	public String executeFunction() throws Exception {
		...
		totalSize = ledgerService.getDestroyPaperSize(map);
		beginIndex = page * pageSize;
		RowBounds rbs = new RowBounds(beginIndex, pageSize);
		paperLedgerList = ledgerService.getDestroyPaperList(map, rbs);
		basicService.setClientMsgRead(getCurUser().getUser_iidd(), "DESTROY_PAPER", 2);
		basicService.setClientMsgRead(getCurUser().getUser_iidd(), "DESTROY_PAPER", 3);
		return SUCCESS;
	}
