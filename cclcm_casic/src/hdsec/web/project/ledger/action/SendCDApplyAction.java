 ...
 * 
 */
public class SendCDApplyAction extends LedgerBaseAction {
	...
	public String executeFunction() throws Exception {
		...
		totalSize = ledgerService.getSendCDSize(map);
		beginIndex = page * pageSize;
		RowBounds rbs = new RowBounds(beginIndex, pageSize);
		cdLedgerList = ledgerService.getSendCDList(map, rbs);
		basicService.setClientMsgRead(getCurUser().getUser_iidd(), "SEND_CD", 2);
		basicService.setClientMsgRead(getCurUser().getUser_iidd(), "SEND_CD", 3);
		return SUCCESS;
	}
