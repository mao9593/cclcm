 ...
 * 
 */
public class MergePaperApplyAction extends LedgerBaseAction {
	...
	public List<EntityStateEnum> getStateList() {
		...
		list.add(EntityStateEnum.STATE9);
		return list;
	}
	...
	public String executeFunction() throws Exception {
		...
		totalSize = ledgerService.getMergePaperApplySize(map);
		beginIndex = page * pageSize;
		RowBounds rbs = new RowBounds(beginIndex, pageSize);
		paperLedgerList = ledgerService.getMergePaperApplyList(map, rbs);
		basicService.setClientMsgRead(getCurUser().getUser_iidd(), "MERGE_ENTITY", 2);
		basicService.setClientMsgRead(getCurUser().getUser_iidd(), "MERGE_ENTITY", 3);
		return SUCCESS;
	}
