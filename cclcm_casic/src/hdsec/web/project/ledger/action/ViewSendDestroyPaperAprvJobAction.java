 ...
 * 
 */
public class ViewSendDestroyPaperAprvJobAction extends LedgerBaseAction {
	...
	public String executeFunction() throws Exception {
		...
		tempList = basicService.getApprovedJobByUserId(getCurUser().getUser_iidd(), JobTypeEnum.SENDES_PAPER,
