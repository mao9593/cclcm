 ...
 * 
 */
public class DelayCDApplyAction extends LedgerBaseAction {
	...
	public String executeFunction() throws Exception {
		...
		totalSize = ledgerService.getDelayCDSize(map);
		beginIndex = page * pageSize;
		RowBounds rbs = new RowBounds(beginIndex, pageSize);
		cdLedgerList = ledgerService.getDelayCDList(map, rbs);
		basicService.setClientMsgRead(getCurUser().getUser_iidd(), "DELAY_CD", 2);
		basicService.setClientMsgRead(getCurUser().getUser_iidd(), "DELAY_CD", 3);
		return SUCCESS;
	}
