 ...
 * 
 */
public class PaperModifyApplyAction extends LedgerBaseAction {
	...
	public List<EntityStateEnum> getStateList() {
		...
		list.add(EntityStateEnum.STATE14);
	...
	public String executeFunction() throws Exception {
		...
		totalSize = ledgerService.getModifyPaperSize(map);
		beginIndex = page * pageSize;
		RowBounds rbs = new RowBounds(beginIndex, pageSize);
		paperLedgerList = ledgerService.getModifyPaperList(map, rbs);
		basicService.setClientMsgRead(getCurUser().getUser_iidd(), "PAPER_DEL", 2);
		basicService.setClientMsgRead(getCurUser().getUser_iidd(), "PAPER_MODIFY", 2);
		basicService.setClientMsgRead(getCurUser().getUser_iidd(), "PAPER_DEL", 3);
		basicService.setClientMsgRead(getCurUser().getUser_iidd(), "PAPER_MODIFY", 3);
		return SUCCESS;
	}
