 ...
 * 
 */
public class ViewSelfSecurityPaperLedgerAction extends LedgerBaseAction {
	...
	public String executeFunction() throws Exception {
		...
		if ((paper_state == null) || (paper_state.equals(""))) {
		...
		if ((seclv_code == null) || (seclv_code.equals(""))) {
			map.put("is_security_result", true);
		}
