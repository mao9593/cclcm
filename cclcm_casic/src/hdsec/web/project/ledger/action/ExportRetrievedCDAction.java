 ...
 * 
 */
public class ExportRetrievedCDAction extends AutoCommonExportAction {
	...
	private final String filename = "已回收光盘台账记录-" + sdf1.format(new Date()) + ".xls";
	private final String sheetName = "已回收光盘台账记录";
	private String cols= "";
	...
	public String executeFunction() throws Exception {
		cols=basicService.getSysConfigItemValue("exportretrievedcd").getItem_value();
