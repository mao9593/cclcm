...
/**
 * 部门管理员查看部门纸质文件 2014-4-29 上午2:11:10
 * 
 * @author gaoximin
 */
public class ViewDeptPaperLedgerAction extends LedgerBaseAction {
	...
	private String jumpLoader = "N"; // 进入的时候判断是否跳转到其loader界面
	private String queryString = ""; // 在进行跳转时，将参数一并带走
	...
	public String getQueryString() {
		return (getRequest().getQueryString() == null || getRequest().getQueryString() == "") ? "" : getRequest()
				.getQueryString();
	}

	public void setJumpLoader(String jumpLoader) {
		this.jumpLoader = jumpLoader;
	}
	...
	public String executeFunction() throws Exception {
		...
		if (this.jumpLoader.equals("N")) {
			...
			paperLedgerList = ledgerService.getSecAllPaperLedgerList(map, rbs);
			return SUCCESS;
		} else {
			return "JUMPLOADER";
		}
