...
public class ManageCDTransferEventAction extends TransferBaseAction {
	...
	public String executeFunction() throws Exception {
		...
		jobList = transferService.getJobListByCD(map);
		for (ProcessJob job : jobList) {
			String event_names = "";
			List<EventTransfer> events = transferService.getTransferEventListByJobCode(job.getJob_code(), "cd");
