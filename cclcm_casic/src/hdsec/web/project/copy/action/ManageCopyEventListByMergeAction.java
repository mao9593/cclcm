 ...
 * 合并管理复印申请列表
 * 
 * @author lishu 2016-12-1
 */
public class ManageCopyEventListByMergeAction extends CopyBaseAction {
	...
	public String getActionContext() {
		return "/copy/managecopyeventlistbymerge.action";
	}
