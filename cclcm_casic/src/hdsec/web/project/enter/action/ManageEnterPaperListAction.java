 ...
 * 
 */
public class ManageEnterPaperListAction extends EnterBaseAction {
	...
	public String getActionContext() {
		return "/enter/manageenterpaperlist.action";
	}
