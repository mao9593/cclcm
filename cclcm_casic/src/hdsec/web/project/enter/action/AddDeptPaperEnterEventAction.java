 ...
 * 
 */
public class AddDeptPaperEnterEventAction extends EnterBaseAction {
	...
	private Integer enter_num = null; // 份数
	private String period = "";// 短期/长期
	private String file_kind = "NORMAL";// 文件说明（NORMAL普通文件，BOOK保密手册）
	...
	private String filed_date = "";// 公文成文日期或刊物编印日期
	...
	public String executeFunction() throws Exception {
		...
		if (StringUtils.hasLength(event_code)) {
			...
			EnterEvent event = new EnterEvent(user_iidd, dept_id, event_code, seclv_code, usage_code, project_code,
					summ, zipfile, medium_serial, page_num, source, place, import_status, file_type, "DEPT",
					scope_dept_id, period, paper_barcode, company, publish_type, fileid, company_send, urgency_lv,
					filed_date, publish_limits, create_type, create_user_name, src_code);
