...
public class SaveArchAction extends ArchBaseAction {
	/**
	 * 
	 */
	...
	public String executeFunction() throws Exception {
		...
		archService.saveArchProperty(archValueMap);
		// 插入档案后，更新档案缓存，方便下次输入代填
		ArchBuffer.setArchBuffer(template_id, archValueMap);
		return SUCCESS;
	}
	...
	private Map<String, Object> getArchPropertyMap() throws Exception {
		...
		String barcode = basicService.createEntityBarcode("ENTERPAPER");
		if (arch_barcode != null || "".equals(arch_barcode)) {
			map.put("BARCODE", arch_barcode);
		} else {
