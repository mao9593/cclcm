...
public class ViewUpdateArchAction extends ArchBaseAction {
	...
	public String executeFunction() throws Exception {
		archValue = archService.getArchValueById(id);
		template_id = archValue.getTemplate_id();
	...
	public ArchValue getArchValue() {
		return archValue;
	}

	public void setArchValue(ArchValue archValue) {
