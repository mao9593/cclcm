...
public class DeviceEvent extends BaseEvent {
	...
	/*
	 * public String getMed_type_name() { String name = ""; if (med_type == null) { return ""; } else { switch
	 * (this.med_type) { case 1: name = "U盘"; break; case 2: name = "移动硬盘"; break; case 3: name = "笔记本"; break; case 4:
	 * name = "照相机"; break; case 5: name = "录像机"; break; case 6: name = "录音笔"; break; case 8: name = "软盘"; break; case
	 * 9: name = "磁带"; break; } return name; } }
	 */
