 ...
 * 
 */
public class ManageDeviceJobAction extends DeviceBaseAction {
	...
	public String getActionContext() {
		return "/device/managedevicejob.action";
	}

	public String getJobType_code() {
		return JobTypeEnum.DEVICE.getJobTypeCode();
	}
	...
	public String executeFunction() throws Exception {
		...
		map.put("jobType_code", JobTypeEnum.DEVICE.getJobTypeCode());
		...
		basicService.setClientMsgRead(getCurUser().getUser_iidd(), "DEVICE", 2);
		basicService.setClientMsgRead(getCurUser().getUser_iidd(), "DEVICE", 3);
		return SUCCESS;
	}
}
