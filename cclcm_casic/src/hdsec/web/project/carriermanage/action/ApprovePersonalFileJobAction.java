...
public class ApprovePersonalFileJobAction extends CarrierManageBaseAction {
	...
	private PersonalFileEvent event = null;
	private List<PersonalFileInfo> pfileinfo = null;
	...
	public PersonalFileEvent getEvent() {
		return event;
	}

	public void setEvent(PersonalFileEvent event) {
		this.event = event;
	}

	public List<PersonalFileInfo> getPfileinfo() {
		return pfileinfo;
	}

	public void setPfileinfo(List<PersonalFileInfo> pfileinfo) {
		this.pfileinfo = pfileinfo;
	}

	private void getPersonalFile(PersonalFileEvent event1) {
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("event_code", event1.getEvent_code());
		pfileinfo = carrierManageService.getFileInfo(map);
	...
	public String executeFunction() throws Exception {
		if (history.equals("Y")) {
			...
			eventList = carrierManageService.getPersonalFileEventListByJobCode(job_code);
			event = eventList.get(0);
			getPersonalFile(event);
			return SUCCESS;
		} else {
