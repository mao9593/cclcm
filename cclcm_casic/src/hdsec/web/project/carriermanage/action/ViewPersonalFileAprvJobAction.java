...
public class ViewPersonalFileAprvJobAction extends CarrierManageBaseAction {
	...
	public String executeFunction() throws Exception {
		...
		tempList = basicService.getApprovedJobByUserId(getCurUser().getUser_iidd(), JobTypeEnum.PERSONAL_FILE,
