 ...
 * 
 */
public class ExportFilePaperAction extends AutoCommonExportAction {
	...
	private final String filename = "已归档文件台账记录-" + sdf1.format(new Date()) + ".xls";
	private final String sheetName = "已归档文件台账记录";
	private String cols= "";
	...
	public String executeFunction() throws Exception {
		cols=basicService.getSysConfigItemValue("exportfilepaper").getItem_value();
