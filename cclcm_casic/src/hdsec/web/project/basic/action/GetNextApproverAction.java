...
public class GetNextApproverAction extends BasicBaseAction {
	...
	public String executeFunction() throws Exception {
		try {
			List<ApproverUser> oriList = basicService.getNextApprover(job_code, dept_id, seclv_code, jobType,
					usage_code);
			...
			if (!basicService.isSelfApprove()) {// 不允许自审批
				...
				if ((userList != null) && (userList.size() == 1) && userList.get(0).getUser_iidd().equals(user_iidd)) {
