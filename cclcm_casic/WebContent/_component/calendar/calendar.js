...
function fSetDate(iYear, iMonth, iDay){
  ...
  if ((iYear == 0) && (iMonth == 0) && (iDay == 0)){
  	...
  	gdCtrl.value = iYear+"-"+iMonth+"-"+iDay + " 00:00:00.000";
  }
...
// i.e.: <input type="text" name="dc" style="text-align:center" readonly><INPUT
// type="button" value="V" onclick="fPopCalendar(dc,dc);return false">
...
write("</SELECT>");
write("&nbsp;<input type='button' name='nextMonth' value='>' style='height:20;width:20;FONT:bold' onclick='fNextMonth()'>");
write("</td>");
write("</TR><TR>");
...
write("<B ID=\"CAL_B_BLANK\" style='color:"+gcBG+"; visibility:visible; cursor:hand; font-size:12px' onclick='fSetDate(0,0,0)' onMouseOver='this.style.color=gcToggle' onMouseOut='this.style.color=gcBG'>清空日期</B>");
