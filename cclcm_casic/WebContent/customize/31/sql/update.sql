...
---增加打印、刻录专员（根据31所需求新加)
if not exists (select 1 from SEC_ROLE where ROLE_ID = '21')
	INSERT INTO SEC_ROLE(ROLE_ID,ROLE_NAME,SUBSYS_CODE,ROLE_DESC,ROLE_TYPE,ROLE_SPEC_KEY) VALUES('21','打印专员','admin','打印外发管理',3,'SPECIALPAPERMANAGER');
GO
if not exists (select 1 from SEC_ROLE where ROLE_ID = '22')
	INSERT INTO SEC_ROLE(ROLE_ID,ROLE_NAME,SUBSYS_CODE,ROLE_DESC,ROLE_TYPE,ROLE_SPEC_KEY) VALUES('22','刻录专员','admin','刻录功能管理',3,'SPECIALCDMANAGER');
GO
