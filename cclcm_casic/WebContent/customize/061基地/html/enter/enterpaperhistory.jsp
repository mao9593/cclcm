...
<head>
	...
	function clearFindForm(){
		...
		LedgerQueryCondForm.user_iidd.value = "";
...
<form id="LedgerQueryCondForm" method="GET" action="${ctx}/enter/enterpaperhistory.action">
	<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center" class="table_only_border">
	<tr>
		<td class="title_box">录入文件列表</td>
	</tr>
	<tr>
		<td align="right">
			<table  table border=0 class="table_box" cellspacing="0" cellpadding="0" width="100%">
				<tr>
					...
					<td>	
					<td>申请人：				
						<input type="text" id="user_iidd" name="user_iidd" value="${user_iidd}" onkeyup="selectRecvUser(this.value);"/><br>
	...
	<tr>
		<td>
			<table class="displaytable-outter" cellspacing=0 cellpadding=0 border=0 width="100%">
	 			<tr>
	   				<td>
	   					<display:table requestURI="${ctx}/enter/enterpaperhistory.action" id="item" class="displaytable" name="paperLedgerList"
