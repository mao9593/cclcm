...
YAHOO.widget.Node.prototype = {
     ...
     * @type boolean
     */
    multiExpand: false,/**tyh modified 2007-10-11**/

    /**事先就知道没有子节点，用于动态加载节点时提前显示没有子节点的节点用
      *iHaveChild:1--有子节点；0--无子节点；-1--叶子节点。
      * add by tyh，2007-9-29
      */
    iHaveChild:"1",
    nodeTypeCode:"ROOT",
    nodeCode:"ROOT",
     ...
     * @type boolean
     */
    renderHidden: true,/**tyh modified to true,2007-10-11*/
...
YAHOO.extend(YAHOO.widget.TextNode, YAHOO.widget.Node, {
    ...
    setUpLabel: function(oData) { 
        ...
        if (oData.iHaveChild) {
            this.iHaveChild=oData.iHaveChild;
            if (this.iHaveChild!="1"){
                this.dynamicLoadComplete=true;
            }
            this.expanded = false;
            this.multiExpand=false;
            this.nodeCode=oData.code;
            this.nodeTypeCode=oData.type;
        }
...
YAHOO.register("treeview", YAHOO.widget.TreeView, {version: "2.3.0-tyh20071011", build: "442"});
