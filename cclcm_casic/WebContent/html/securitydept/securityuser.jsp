...
<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center" class="table_only_border">
	<tr>
		<td class="title_box">专职保密人员</td>
	</tr>
	<form id="ContactQueryCondForm" method="post" action="${ctx}/securitydept/securityuser.action?type=3">
	<tr>
		<td align="right">
	...
	<tr>
		<td>
			<table class="displaytable-outter" cellspacing=0 cellpadding=0 border=0 width="100%">
	 			...
	 			<tr>
	   				<td>
	   					<display:table requestURI="${ctx}/securitydept/securityUser.action?type=3" uid="item" class="displaytable" name="securityDeptList"
