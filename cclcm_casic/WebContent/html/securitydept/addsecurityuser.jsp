...
<center>
<form method="post" action="${ctx}/securitydept/addsecurityuser.action">
  	<table class="table_box" cellspacing=0 cellpadding=0 border=1 width="95%">
	 <tr>
		 <td colspan="8" class="title_box">添加保密组织机构</td>
    </tr>
    <tr>
		...
		<td>
			<select name="type" id="type">
    			...
    			<option value="1">保密委员会</option>
    			<option value="2">保密处</option>
    			<!-- <option value="3">专职保密人员</option> -->
    			<option value="4">部门兼（专）职保密员</option>
    		</select>
		</td>
	<tr>
