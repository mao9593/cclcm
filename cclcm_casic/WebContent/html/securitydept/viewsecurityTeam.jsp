...
<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center" class="table_only_border">
	<tr>
		<td class="title_box">保密处</td>
	</tr>
	<form id="ContactQueryCondForm" method="post" action="${ctx}/securitydept/viewsecurityTeam.action?type=2">
	<tr>
		<td>
			<table class="displaytable-outter" cellspacing=0 cellpadding=0 border=0 width="100%">
	 			<tr>
	   				<td>
	   					<display:table requestURI="${ctx}/securitydept/viewsecurityTeam.action?type=2" uid="item" class="displaytable" name="securityDeptList"
