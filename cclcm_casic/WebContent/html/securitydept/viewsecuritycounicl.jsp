...
<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center" class="table_only_border">
	<tr>
		<td class="title_box">保密委员会</td>
	</tr>
	<form id="ContactQueryCondForm" method="post" action="${ctx}/securitydept/viewsercuritycounicl.action?type=1">
	<tr>
		<td>
			<table class="displaytable-outter" cellspacing=0 cellpadding=0 border=0 width="100%">
	 			<tr>
	   				<td>
	   					<display:table requestURI="${ctx}/securitydept/sercuritycounicl.action?type=1" uid="item" class="displaytable" name="securityDeptList"
