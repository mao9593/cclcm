...
<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center" class="table_only_border">
	...
	<form id="ContactQueryCondForm" method="post" action="${ctx}/securitydept/securityTeam.action?type=2">
	<tr>
		<td align="right">
	...
	<tr>
		<td>
			<table class="displaytable-outter" cellspacing=0 cellpadding=0 border=0 width="100%">
	 			...
	 			<tr>
	   				<td>
	   					<display:table requestURI="${ctx}/securitydept/securityTeam.action?type=2" uid="item" class="displaytable" name="securityDeptList"
