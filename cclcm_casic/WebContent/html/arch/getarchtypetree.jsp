...
%>
	tree.add("t<%=type.getID()%>",
             "__x",
             "<%=type.getType_name()%>",
             "javascript:window.location='${ctx}/<%=type.getContext()%>?id=<%=type.getID()%>'",
...
%>      
	tree.add("i<%=it.getId()%>",
             "t<%=it.getType_id()%>",
             "<%=it.getItem_code()%>",
             "javascript:window.location='${ctx}/<%=it.getContext()%>?id=<%=it.getId()%>'",
...
%>
	tree.add("d<%=dos.getId()%>",
             "i<%=dos.getItem_id()%>",
             "<%=dos.getDos_code()%>",
             "javascript:window.location='${ctx}/<%=dos.getContext()%>?id=<%=dos.getId()%>'",
