...
<head>
	...
	function clearFindForm(){
			...
			LedgerQueryCondForm.duty_dept_name.value = "";
	}	
	...
	function addCopyJob(){
		...
		if(checked+hidded == 0){
			...
			$("#LedgerQueryCondForm").attr("action","${ctx}/copy/addcopyprocessjob.action");
...
<body >
<form id="LedgerQueryCondForm" method="GET" action="${ctx}/copy/submitcopyeventbyledger.action">
	...
	<tr>
		<td>
			<table class="displaytable-outter" cellspacing=0 cellpadding=0 border=0 width="100%">
	 			<tr>
	   				<td>
	   					<display:table requestURI="${ctx}/copy/submitcopyeventbyledger.action" id="item" class="displaytable" name="paperLedgerList"
