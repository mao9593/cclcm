...
<form id="LedgerQueryCondForm" method="POST" action="${ctx}/copy/viewcopypaperledgerbymerge.action">
    ...
    <tr>
        <td>
            <table class="displaytable-outter" cellspacing=0 cellpadding=0 border=0 width="100%">
                <tr>
                    <td>
                        <display:table requestURI="${ctx}/copy/viewcopypaperledgerbymerge.action" id="item" class="displaytable" name="paperLedgerList"
