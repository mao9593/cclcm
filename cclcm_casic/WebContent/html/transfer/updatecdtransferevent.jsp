...
<form action="${ctx}/transfer/submitupdatecdtransferevent.action" method="POST">
	...
	<tr> 
    	...
    	<td><select name="usage_code" id="usage">
    ...
    <tr>
		...
		<td colspan="3">
      		<textarea name="summ" rows="3" cols="60" id="summ" value="${summ}"></textarea>
		</td>
    </tr>
  	<tr>
