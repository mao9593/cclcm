...
<table border="0" class="displaytable-outter" cellspacing="0" cellpadding="0" width="100%" height="370">
	<tr height="25">
		<td class="title_box">部门列表</td>
	</tr>
	<tr height="285">
		<td valign="top">
			<div style="overflow:auto;height:100%;width:100%">
					<display:table requestURI="" uid="dept" name="deptList" class="displaytable">
		                <display:column title="序号" >
								<c:out value="${dept_rowNum}"/>
						</display:column>
		                 <display:column title="部门名称" property="dept_name" />
		                 <display:column title="部门描述" property="dept_desc" />
					</display:table>
			</div>
		</td>
	</tr>
