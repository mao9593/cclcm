...
<table border="0" class="displaytable-outter" cellspacing="0" cellpadding="0" width="100%" height="370">
	<tr height="25">
		<td class="title_box">用户列表</td>
	</tr>
	<tr height="185">
		<td valign="top">
		<div style="overflow:auto;height:100%;width:100%">
			<display:table requestURI="" uid="secUser" name="secUserList" class="displaytable">
                <display:column title="序号">
						<c:out value="${secUser_rowNum}"/>
				</display:column>
                 <display:column title="登录名" property="user_iidd"/>
