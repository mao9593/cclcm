...
<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center" class="table_only_border">
	<tr>
		<td class="title_box">归档光盘二次处理任务列表</td>
	</tr>
	<form id="LedgerQueryCondForm" method="GET" action="${ctx}/ledger/managefilecdevent.action" name="LedgerQueryCondForm">
	<tr>
		<td>
