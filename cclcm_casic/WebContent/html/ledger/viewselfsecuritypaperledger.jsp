...
<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center" class="table_only_border">
	...
	<form id="LedgerQueryCondForm" method="GET" action="${ctx}/ledger/viewselfsecuritypaperledger.action">
			...
			<table  table border=0 class="table_box" cellspacing="0" cellpadding="0" width="100%">
				...
				<tr>
					...
					<td >
						<select name="paper_state" id="paper_state">
						    <option value="">--所有--</option>
			    			<option value="0" <c:if test="${paper_state ==0}">selected</c:if>>留用</option>
			    			<option value="8" <c:if test="${paper_state ==8}">selected</c:if>>申请外发</option>
			    			<option value="9" <c:if test="${paper_state ==9}">selected</c:if>>申请归档</option>
			    			<option value="15" <c:if test="${paper_state ==15}">selected</c:if>>申请销毁</option>
							<%-- <option value="">--所有--</option>
				...
				<tr>
					...
					<td align="center" colspan="2"> 
						...
						<input type="button" class="button_2003" value="导出EXCEL" onclick="exportLedger('LedgerQueryCondForm','${ctx}/ledger/exportpersonalpaperledger.action','${ctx}/ledger/viewselfsecuritypaperledger.action');"/>
					</td>		
				</tr>
			</table>
		</td>
	...
	<tr>
		<td>
			<table class="displaytable-outter" cellspacing=0 cellpadding=0 border=0 width="100%">
	 			<tr>
	   				<td>
	   					<display:table requestURI="${ctx}/ledger/viewselfsecuritypaperledger.action" uid="item" class="displaytable" name="paperLedgerList"
...
<!-- 			 <label style="width: 150">
				<input type="radio" name="jobType" value="PAPER_DEL"/>录入错误文件删除
			</label>
			<label style="width: 150">
				<input type="radio" name="jobType" value="PAPER_MODIFY"/>录入错误文件修改
			</label> -->
			<br><br>
