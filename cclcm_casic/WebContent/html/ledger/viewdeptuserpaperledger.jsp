...
<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center" class="table_only_border">
	<tr>
		<td class="title_box">部门用户纸质台账列表</td>
	</tr>
	<form id="LedgerQueryCondForm" method="post" action="${ctx}/ledger/viewdeptuserpaperledger.action">
				...
				<tr>
					...
					<td>
						<select name="create_type" id="create_type">
    						...
    						<option value="OUTCOPY">外来文件复印</option>
						</select>
					</td>																			
				</tr>	
				<tr>
	...
	<tr>
		<td>
			<table class="displaytable-outter" cellspacing=0 cellpadding=0 border=0 width="100%">
	 			<tr>
	   				<td>
	   					<display:table requestURI="${ctx}/ledger/viewdeptuserpaperledger.action" uid="item" class="displaytable" name="paperLedgerList"
							...
							<display:column property="duty_dept_name" title="部门" maxLength="20"/>
	...
	<tr><td><input type="button" class="button_2003" value="导出EXCEL" onclick="exportLedger('LedgerQueryCondForm','${ctx}/ledger/exportdeptuserpaperledger.action','${ctx}/ledger/viewdeptuserpaperledger.action');"/></td></tr>
