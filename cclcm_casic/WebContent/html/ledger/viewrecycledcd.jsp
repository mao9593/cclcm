...
<head>
	...
	function chkSubmit(){
		...
		if(checked+hidded >0){
				$("#LedgerQueryCondForm").attr("action","${ctx}/basic/handlecdsenddestroy.action");
...
<body>
<form id="LedgerQueryCondForm" method="GET" action="${ctx}/ledger/viewrecycledcd.action">
	<input type="hidden" name="dept_ids" id="dept_ids" value="${dept_ids}" />
	<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center" class="table_only_border">
	<tr>
		<td class="title_box">已回收光盘列表</td>
	</tr>
	<tr>
		<td align="right">
	...
	<tr>
		<td>
			<table class="displaytable-outter" cellspacing=0 cellpadding=0 border=0 width="100%">
	 			<tr>
	   				<td>
	   					<display:table requestURI="${ctx}/ledger/viewrecycledcd.action" id="item" class="displaytable" name="cDLedgerList"
				...
				<tr>
					<td>
						<input type="hidden" name="jobType" value="SENDES_CD"/>
						<input type="button" class="button_2003" value="批量送销" onclick="return chkSubmit();"/>&nbsp;
						请在同一批次勾选<font color="red"><b>相同密级</b></font>的光盘进行送销，为了保证程序运行稳定，同一批次送销的光盘数最好不要超过<font color="red"><b>40</b></font>个
					</td>
				</tr>
	         </td>
		</tr>
