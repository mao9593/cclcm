...
<form method="post" action="${ctx}/ledger/addtransferevent.action" id="hid_event_form">
...
<form id="LedgerQueryCondForm" method="POST" action="${ctx}/ledger/viewpersonalledger.action">
	...
	<tr><td><input type="button" class="button_2003" value="导出EXCEL" onclick="exportLedger('LedgerQueryCondForm','${ctx}/ledger/exportpersonalcdledger.action','${ctx}/ledger/viewpersonalledger.action');"/></td></tr>
	</table>
 </form>
</body>
</html>
