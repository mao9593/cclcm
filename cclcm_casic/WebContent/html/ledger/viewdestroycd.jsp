...
<form id="LedgerQueryCondForm" method="GET" action="${ctx}/ledger/viewdestroycd.action">
	<input type="hidden" name="dept_ids" id="dept_ids" value="${dept_ids}" />
	<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center" class="table_only_border">
	<tr>
		<td class="title_box">已销毁光盘列表</td>
	</tr>
	<tr>
		<td>
			<table  table border=0 class="table_box" cellspacing="0" cellpadding="0" width="100%">
				<tr>
					...
					<td align="center" rowspan="2">
						...
						<input type="button" class="button_2003" value="导出EXCEL" onclick="exportLedger('LedgerQueryCondForm','${ctx}/ledger/exportdestroycd.action','${ctx}/ledger/viewdestroycd.action');"/>
					</td>
				</tr>
				<tr>
	...
	<tr>
		<td>
			<table class="displaytable-outter" cellspacing=0 cellpadding=0 border=0 width="100%">
	 			<tr>
	   				<td>
						<display:table requestURI="${ctx}/ledger/viewdestroycd.action" id="item" class="displaytable" name="cdLedgerList"
