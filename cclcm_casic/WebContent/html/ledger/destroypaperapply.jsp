...
<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center" class="table_only_border">
	<tr>
		<td class="title_box">已申请销毁纸质台账列表</td>
	</tr>
	<form id="LedgerQueryCondForm" method="GET" action="${ctx}/ledger/destroypaperapply.action" name="LedgerQueryCondForm">
	<tr>
		<td>
	   					...
	   					<display:table uid="item" class="displaytable" name="paperLedgerList" pagesize="${pageSize}" partialList="true" sort="page"  size="${totalSize}"  form="LedgerQueryCondForm" excludedParams="*">
							...
							<div>
								...
								<c:choose>
									...
									<c:when test="${item.job_status eq 'true' && item.paper_state != 4 &&  item.paper_state != 1 && item.paper_state != 11}">
