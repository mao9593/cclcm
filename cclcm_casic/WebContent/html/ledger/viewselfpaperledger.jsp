			...
			if(submitable){
				if($(":radio:checked").size() == 0){
					...
					if($(":radio:checked").val()!="CARRYOUT_PAPER"){
						if($(":radio:checked").val() == "MERGE_ENTITY"){
							if(tag <2){
								alert("合并台账请勾选多份台账提交申请");
								return false;
							}else{
								alert("台账合并后无法解除合并，请慎用");
							}
						}
...
<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center" class="table_only_border">
	...
	<form id="LedgerQueryCondForm" method="GET" action="${ctx}/ledger/viewselfpaperledger.action">
			...
			<table  table border=0 class="table_box" cellspacing="0" cellpadding="0" width="100%">
				...
				<tr>
					...
					<td align="center" colspan="2"> 
						...
						<input type="button" class="button_2003" value="导出EXCEL" onclick="exportLedger('LedgerQueryCondForm','${ctx}/ledger/exportpersonalpaperledger.action','${ctx}/ledger/viewselfpaperledger.action');"/>
					</td>		
				</tr>
			</table>
		</td>
	...
	<tr>
		<td>
			<table class="displaytable-outter" cellspacing=0 cellpadding=0 border=0 width="100%">
	 			<tr>
	   				<td>
	   					<display:table requestURI="${ctx}/ledger/viewselfpaperledger.action" uid="item" class="displaytable" name="paperLedgerList"
...
<table width="95%" align="center" border="0" cellspacing="0" cellpadding="0" align="center" class="table_only_border">
	<tr height="40">
		<td align="center">
			...
			<label style="width: 80">
				<input type="radio" name="jobType" value="MERGE_ENTITY"/>台账合并
			</label>
			<br><br>
