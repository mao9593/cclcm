...
<form id="LedgerQueryCondForm" method="GET" action="${ctx}/ledger/viewrejectsendcd.action">
    <input type="hidden" name="dept_ids" id="dept_ids" value="${dept_ids}" />
	<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center" class="table_only_border">
		<tr>
			<td class="title_box">已拒绝外发光盘列表</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			<td>
				<table class="displaytable-outter" cellspacing=0 cellpadding=0 border=0 width="100%">
		 			<tr>
		   				<td>
						<display:table requestURI="${ctx}/ledger/viewrejectsendcd.action" id="item" class="displaytable" name="cdLedgerList"
