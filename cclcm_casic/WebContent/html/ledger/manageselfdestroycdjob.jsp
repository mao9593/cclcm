...
<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center" class="table_only_border">
	...
	<form id="LedgerQueryCondForm" method="GET" action="${ctx}/ledger/manageselfdestroycdjob.action" name="LedgerQueryCondForm">
	<tr>
		<td>
	   					...
	   					<display:table uid="item" class="displaytable" name="cdLedgerList" pagesize="${pageSize}" sort="page"
							...
							<div>
								...
								<c:choose>
									...
									<c:when test="${item.job_status eq 'true' and (item.cd_state == 15 or item.cd_state == 9)}">
