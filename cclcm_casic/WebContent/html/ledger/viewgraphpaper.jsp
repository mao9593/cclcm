...
<form id="LedgerQueryCondForm" method="GET" action="${ctx}/ledger/viewgraphpaper.action">
	...
	<tr>
		<td>
			<table class="displaytable-outter" cellspacing=0 cellpadding=0 border=0 width="100%">
	 			<tr>
	   				<td>
	   					<display:table requestURI="${ctx}/ledger/viewgraphpaper.action" id="item" class="displaytable" name="paperLedgerList"
						...
						<display:column property="file_title" title="图纸名称" maxLength="35"/>
						...
						<display:column title="补打条码" style="width:100px">
