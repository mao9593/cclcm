...
<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center" class="table_only_border">
	<tr>
		<td class="title_box">部门中转盘台账列表</td>
	</tr>
	<form id="LedgerQueryCondForm" method="GET" action="${ctx}/disc/viewdeptchangespacecdledger.action">
	<tr>
		<td align="right">
	...
	<tr>
		<td>
			<table class="displaytable-outter" cellspacing=0 cellpadding=0 border=0 width="100%">
	 			<tr>
	   				<td>
	   					<display:table requestURI="${ctx}/disc/viewdeptchangespacecdledger.action" uid="item" class="displaytable" name="items"
							...
							<display:column title="操作" style="width:240px">
								...
								<input type="button" class="button_2003" value="一键转换" onclick="go('${ctx}/disc/spacecdchangedeptentitycd.action?id=${item.id }');"/>							
							</display:column>
						</display:table>
					</td>
				</tr>
