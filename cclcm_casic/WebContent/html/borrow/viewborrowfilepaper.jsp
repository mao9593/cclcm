...
<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center" class="table_only_border">
	...
	<form id="LedgerQueryCondForm" method="POST" action="${ctx}/borrow/viewborrowfilepaper.action">
	<tr>
		<td align="right">
	...
	<tr>
		<td>
			<table class="displaytable-outter" cellspacing=0 cellpadding=0 border=0 width="100%">
	 			<tr>
	   				<td>
	   					<display:table requestURI="${ctx}/borrow/viewborrowfilepaper.action" uid="item" class="displaytable" name="paperLedgerList"
							...
							<display:column property="retrieve_time" title="归档时间"/>
