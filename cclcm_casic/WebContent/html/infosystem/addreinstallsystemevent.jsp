...
function selectNextApprover(){
	...
	$("#jobType").val("EVENT_REINSTALL");//设置状态
...
<center>
<form method="post" action="${ctx}/infosystem/addreinstallsystemevent.action">
	...
	<input type="hidden" name="next_approver" id="next_approver"/>
  	<table class="table_box" cellspacing=0 cellpadding=0 border=1 width="90%">
	  	<tr>
		    <td colspan="6" class="title_box">计算机重装系统申请(<font color="blue">开箱维修不能用此申请</font>)</td>
		</tr>
		<tr height="40"> 
	    ...
	    <tr>
			<td align="center"><font color="red">*</font>重装原因</td>
			<td colspan="5">
