...
<center>
<form method="post" action="${ctx}/infosystem/addusbkeyevent.action">
	...
	<input type="hidden" name="next_approver" id="next_approver"/>
  	<table class="table_box" cellspacing=0 cellpadding=0 border=1 width="90%">
	    ...
	    <tr>
	    	<td align="center"><font color="red">*</font>申请内容</td>
			<td width="20%">
				<select name="apply_type" id="apply_type">
					...
					<!--<option value="4">责任人变更</option>-->
					<option value="5">丢失遗失</option>
				</select>
			</td>
	    	<td align="center"><font color="red">*</font>权限类别</td>
	    	<td width="20%">
				<select name="power_type" id="power_type">
					<option value="">--请选择--</option>
					<option value="1">普通用户权限</option>
