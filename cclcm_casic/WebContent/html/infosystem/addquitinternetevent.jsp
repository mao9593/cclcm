...
function selectNextApprover(){
	...
	$("#jobType").val("EVENT_QUITINT");//设置状态
...
<center>
<form method="post" action="${ctx}/infosystem/addquitinternetevent.action">
	...
	<input type="hidden" name="next_approver" id="next_approver"/>
  	<table class="table_box" cellspacing=0 cellpadding=0 border=1 width="90%">
	  	<tr>
		    <td colspan="6" class="title_box">计算机退网</td>
		</tr>
		<tr height="40"> 
	    ...
	    <tr>
			...
			<td colspan="3"><font color="blue"><b>&nbsp;${computer.storage_location}</b></font></td>
    	</tr>
	    <tr>
			<td align="center"><font color="red">*</font>退网原因</td>
			<td colspan="3">
