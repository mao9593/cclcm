...
<center>
<form method="post" action="${ctx}/securityuser/updatecompanycontanct.action">
  	<table class="table_box" cellspacing=0 cellpadding=0 border=1 width="95%">
	 <tr>
		 <td colspan="6" class="title_box">修改首页联系人</td>
    ...
    <tr>
		...
		<td>
			<input type="text" width="17%" name="mobile" id="mobile" value="${contact.mobile}"/>
		</td>
    </tr>
    <tr>
		...
		<td>
			<input type="text" name="rank" id="rank" value="10" value="${contact.rank}"/>
		</td>
    </tr>
    <tr>
    	
    	<td align="center">备注：</td>
		<td colspan="5"><textarea name="reark" rows="4" cols="80" id="reark" >${contact.reark}</textarea></td>
