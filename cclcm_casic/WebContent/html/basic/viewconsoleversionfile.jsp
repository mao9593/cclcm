...
<form id="LedgerQueryCondForm" method="POST" action="${ctx}/basic/viewconsoleversionfile.action">
	...
	<tr>
		<td>
			<table class="displaytable-outter" cellspacing=0 cellpadding=0 border=0 width="100%">
	 			<tr>
	   				<td>
	   				<display:table requestURI="${ctx}/basic/viewconsoleversionfile.action" id="item" class="displaytable" name="versions"  
