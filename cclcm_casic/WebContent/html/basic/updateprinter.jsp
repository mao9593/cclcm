...
<title>修改打印机</title>
	...
	function init(){
		$("#printer_type").val("${printer.printer_type}");
		$("#printer_color").val("${printer.printer_color}");
		$("#is_double").val("${printer.is_double}");
	}
	function chk()
	{
...
<form method="post" action="${ctx}/basic/updateprinter.action">
    ...
    <tr>
		...
		<td>
			<input type="text" name="printer_name" id="printer_name" value="${printer.printer_name}"/>
		</td>
    </tr>
    <tr>
    	<td align="center"><font color="red">*</font>打印机路径：</td>
		<td>
			<input type="text" name="printer_path" id="printer_path" value="${printer.printer_path}"/>
		</td>
	<!-- 
    </tr>
        <tr>
		...
		<td>
			<input type="text" id="dept_name" value="${printer.dept_name}"  readonly="readonly" style="cursor:hand" onclick="openDeptSelect('dept_name','dept_id','radio')" />
    ...
    <tr>
		...
		<td>
			<input type="text" name="printer_brand" id="printer_brand" value="${printer.printer_brand}"/>
		</td>
    </tr>
    <tr>
    	<td align="center">型号：</td>
		<td>
			<input type="text" name="printer_model" id="printer_model" value="${printer.printer_model}"/>
		</td>
    </tr>
    <tr>
    	<td align="center">地理位置：</td>
		<td>
			<input type="text" name="printer_location" id="printer_location" value="${printer.printer_location}"/>
		</td>
    </tr>
    <tr>
    	<td align="center">网络打印机IP：</td>
		<td>
			<input type="text" name="printer_ipaddr" id="printer_ipaddr" value="${printer.printer_ipaddr}"/>
		</td>
    </tr>
    <tr>
