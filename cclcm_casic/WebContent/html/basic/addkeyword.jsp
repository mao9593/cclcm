...
<center>
<form method="post" action="${ctx}/basic/addkeyword.action">
    ...
    <tr>
		...
		<td>
			<input type="text" name="keyword_content" id="keyword_content"/>
    ...
    <tr>
		...
		<td>
			<textarea rows="3" cols="60" name="keyword_detail" id="keyword_detail"></textarea>
		</td>
    </tr>
    <tr>
