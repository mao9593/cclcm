...
<head>
	...
	function creatHighcharts() {
        ...
        for (var i = 0; i < dept_names.length; i++) {
    		...
    		var double_counts=2;
            for (var j = 0; j < double_counts; j++) {
                var brightness = 0.2 - (j / double_counts) / 5 ;
                doubleData.push({
                    name: double_names[j],
                    y: parseInt(page_counts[double_counts*i+j]),
...
<form id="LedgerQueryCondForm" method="POST" action="${ctx}/basic/viewpaperstaticbydouble.action">
			...
			<table  table border=0 class="table_box" cellspacing="0" cellpadding="0" width="100%">
				<tr>
					...
					<td align="center">
						...
						<input type="button" class="button_2003" value="导出EXCEL" onclick="if(chk()) exportLedger('LedgerQueryCondForm','${ctx}/ledger/exportpaperstaticbydouble.action','${ctx}/basic/viewpaperstaticbydouble.action');"/>
					</td>
				</tr>
			</table>
		</td>
	...
	<tr>
		<td>
			<table class="displaytable-outter" cellspacing=0 cellpadding=0 border=0 width="100%">
	 			<tr>
	   				<td>
						<display:table requestURI="${ctx}/basic/viewpaperstaticbydouble.action" id="item" class="displaytable" name="paperStaticList" pagesize="15" sort="list" >	   					
