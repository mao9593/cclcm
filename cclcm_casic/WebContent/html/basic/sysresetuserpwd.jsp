...
<head>
  ...
  <iframe id="mp" width="0" height="0" ></iframe>
  	<form method="post" action="${ctx}/basic/sysresetuserpwd.action" name="SecUserQueryCondForm" id="SecUserQueryCondForm">
    ...
    <tr>
      <td>
      	   <display:table requestURI="${ctx}/basic/sysresetuserpwd.action" id="user" class="displaytable" name="secUserList">
