...
<body >
<form id="LedgerQueryCondForm" method="GET" action="${ctx}/change/viewdeptcdledger.action">
	<input type="hidden" name="entity_type" value="cd"/>
	<input type="hidden" name="change_type" value="toPERSON"/>
	<input type="hidden" name="actionContext" value="change/viewdeptcdledger.action"/>
	<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center" class="table_only_border">
	<tr>
		<td class="title_box">申请部门光盘转为个人光盘</td>
	</tr>
	<tr>
		<td align="right">
	...
	<tr>
		<td>
			<table class="displaytable-outter" cellspacing=0 cellpadding=0 border=0 width="100%">
	 			<tr>
	   				<td>
	   					<display:table requestURI="${ctx}/change/viewdeptcdledger.action" id="item" class="displaytable" name="cdLedgerList"
