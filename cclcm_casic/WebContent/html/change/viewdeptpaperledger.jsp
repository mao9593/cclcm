...
<body >
<form id="LedgerQueryCondForm" method="GET" action="${ctx}/change/viewdeptpaperledger.action">
	<input type="hidden" name="entity_type" value="paper"/>
	<input type="hidden" name="change_type" value="toPERSON"/>
	<input type="hidden" name="actionContext" value="change/viewdeptpaperledger.action"/>
	<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center" class="table_only_border">
	<tr>
		<td class="title_box">申请部门文件转为个人文件</td>
	</tr>
	<tr>
		<td align="right">
	...
	<tr>
		<td>
			<table class="displaytable-outter" cellspacing=0 cellpadding=0 border=0 width="100%">
	 			<tr>
	   				<td>
	   					<display:table requestURI="${ctx}/change/viewdeptpaperledger.action" id="item" class="displaytable" name="paperLedgerList"
						...
						<display:column property="print_time" title="制作时间" sortable="true"/>
