...
<body >
<form id="LedgerQueryCondForm" method="GET" action="${ctx}/change/viewpersonalpaperledger.action">
	<input type="hidden" name="entity_type" value="paper"/>
	<input type="hidden" name="change_type" value="toDEPT"/>
	<input type="hidden" name="actionContext" value="change/viewpersonalpaperledger.action"/>
	<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center" class="table_only_border">
	<tr>
		<td class="title_box">申请个人文件转为部门文件</td>
	</tr>
	<tr>
		<td align="right">
	...
	<tr>
		<td>
			<table class="displaytable-outter" cellspacing=0 cellpadding=0 border=0 width="100%">
	 			<tr>
	   				<td>
	   					<display:table requestURI="${ctx}/change/viewpersonalpaperledger.action" id="item" class="displaytable" name="paperLedgerList"
