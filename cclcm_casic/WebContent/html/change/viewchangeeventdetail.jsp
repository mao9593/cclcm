...
<table width="95%" border="1" cellspacing="0" cellpadding="0" align="center" class="table_box">
	<tr>
	    <td colspan="4" class="title_box">查看作业详情</td>
	</tr>
	<tr>
		<td width="15%" align="center">载体条码：</td>
	    <td width="35%"><font color="blue"><b>&nbsp;${event.barcode}</b></font></td>
	    <td width="15%" align="center">当前状态： </td>
    	<td width="35%"><font color="red"><b>&nbsp;${event.job_status_name}&nbsp;/&nbsp;${event.change_status_name}</b></font></td>
	</tr>
	<tr>
...
<c:if test="${event.change_type == 'toPERSON'}">
	<tr>
		<td align="center">用户名称：</td>
	    <td colspan="3"><font color="blue"><b>&nbsp;${user_name}</b></font></td>
	</tr>
</c:if>
	<tr> 
